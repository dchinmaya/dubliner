...
module Helper
  ...
  def fileRead(filename)
    ...
    raise ArgumentError, "File #{filename} is not readable. Verify access permissions of the file" unless
  ...
  def distanceCalculator(la1, lo1, la2, lo2)
    raise ArgumentError, 'Latitude and Longitude cant be nil' if la1.nil? || la2.nil? || lo1.nil? || lo2.nil?
